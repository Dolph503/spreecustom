...
ActiveRecord::Schema[7.2].define(version: 2025_06_13_094902) do
  ...
  create_table "spree_products", force: :cascade do |t|
    ...
    t.index ["template_id"], name: "index_spree_products_on_template_id"
  end
  ...
  add_foreign_key "spree_products", "templates"
