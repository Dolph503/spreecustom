module Spree
  module Cart
    class AddItem
      ...
      def call(order:, variant:, quantity: nil, public_metadata: {}, private_metadata: {}, options: {},custom_design:)
      ...
      def add_to_line_item(order:, variant:, quantity: nil, public_metadata: {}, private_metadata: {}, options: {},custom_design:)
        options ||= {}
        quantity ||= 1
        ...
        line_item.custom_design_json = custom_design if custom_design
